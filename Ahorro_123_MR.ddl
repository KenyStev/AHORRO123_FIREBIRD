...
CREATE TABLE ABONOS
  (
    ID_ABONO     NUMBER (8) NOT NULL ,
    CODIGO_ABONO VARCHAR2 (150) ,
    MONTO FLOAT ,
    FECHA          DATE ,
    DESCRIPCION    VARCHAR2 (200) ,
    FECHA_CREADO   DATE ,
    FECHA_MODIFI   DATE ,
    USUARIO_CREO   VARCHAR2 (50) NOT NULL ,
    USUARIO_MODIFI VARCHAR2 (50) NOT NULL ,
...
CREATE TABLE EMPLEADOS
  (
    ...
    FECHA_NAC      DATE ,
    FECHA_CONTRATO DATE ,
    NOMBRE_N1      VARCHAR2 (50) ,
    NOMBRE_N2      VARCHAR2 (50) ,
    NOMBRE_A1      VARCHAR2 (50) ,
    NOMBRE_A2      VARCHAR2 (50) ,
    DIREC_REFER    VARCHAR2 (50) ,
    DIREC_CALLE    VARCHAR2 (50) ,
    DIREC_AVE      VARCHAR2 (50) ,
    DIREC_NUM_CASA VARCHAR2 (50) ,
    DIREC_CIUDAD   VARCHAR2 (50) ,
    DIREC_DEPTO    VARCHAR2 (50) ,
    CORREO_2       VARCHAR2 (100) ,
    FECHA_CREADO   DATE ,
    FECHA_MODIFI   DATE ,
    USUARIO_CREO   VARCHAR2 (50) NOT NULL ,
    USUARIO_MODIFI VARCHAR2 (50) NOT NULL ,
...
CREATE TABLE EXTERNOS
  (
    ID_EXTERNO      NUMBER (8) NOT NULL ,
    FECHA_NAC       DATE ,
    PARENTESCO_AVAL VARCHAR2 (50) ,
    NOMBRE_N1       VARCHAR2 (50) ,
    NOMBRE_N2       VARCHAR2 (50) ,
    NOMBRE_A1       VARCHAR2 (50) ,
    NOMBRE_A2       VARCHAR2 (50) ,
    ...
    DIREC_CALLE     VARCHAR2 (50) ,
    DIREC_AVE       VARCHAR2 (50) ,
    DIREC_NUN_CASA  VARCHAR2 (50) ,
    DIREC_CIUDAD    VARCHAR2 (50) ,
    DIREC_DEPTO     VARCHAR2 (50) ,
    CORREO_1        VARCHAR2 (100) ,
    CORREO_2        VARCHAR2 (100) ,
    FECHA_CREADO    DATE ,
    FECHA_MODIFI    DATE ,
    USUARIO_CREO    VARCHAR2 (50) NOT NULL ,
...
CREATE TABLE PRESTAMOS
  (
    ...
    MONTO FLOAT ,
    FECHA          DATE ,
    ID_EMPLE_AVAL  NUMBER (8) NOT NULL ,
    FECHA_CREADO   DATE ,
    FECHA_MODIFI   DATE ,
    USUARIO_CREO   VARCHAR2 (50) NOT NULL ,
    USUARIO_MODIFI VARCHAR2 (50) NOT NULL ,
