...
<?php
		$ide=$_GET['id'];
		$query= "SELECT * FROM EMPLEADOS E WHERE E.ID_EMPLEADO=$ide";
...
if (isset($_POST["btn_modificar"]))
{
    ...
    if($btn == "Guardar Cambios")
    {
		...
		$query = "EXECUTE PROCEDURE SP_EMPLEADOS_UPDATE('$ide','$fecha_nacimiento','$fecha_contratacion','$PN','$SN','$PA','$SA','$Direc_Referencia','$Direc_Calle','$Direc_Avenida','$Direc_Num_Casa','$Direc_Ciudad','$Direc_Depto','$Correo_2','SYSDBA','$Correo_1')";
		...
		echo "<script> alert('Un Empleado ha sido Actualizado');</script>";
		?>
...
<center>	
	...
	<form name="fe" action="" method="POST">
        ...
        <tr>
            <td align="center"><b>Fecha de Contratacion:  </b></td><td><label><input name="fecha_contratacion" type="date" size=35 value="<?echo $row->FECHA_CONTRATO?>" style="font-size:18px" required /></label></td>
        </tr>
        <tr>
        <!-- Primer Nombre -->
        <tr>
        ...
        <tr>
            <td align="center"><b>Direccion Numero de Casa:  </b></td><td><label><input name="Direc_Num_Casa" type="text" size=35 style="font-size:18px" value="<?echo $row->DIREC_NUM_CASA?>" required /></label></td>
        </tr>
        <!-- Direccion Ciudad -->
        <tr>
        ...
        <!-- Correo Primario ID_USUARIO -->
        <tr>
            <td align="center"><b>Correo Primario:  </b></td><td><label><input name="Correo_1" type="text" size=35 style="font-size:18px" value="<?echo $row->ID_USUARIO?>" required /></label></td>
        </tr>
        <!-- Correo Secundario -->
        <tr>
